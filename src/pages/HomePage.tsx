...
const HomePage: FC<HomePageProps> = () => {
    ...
    const { control, handleSubmit, watch } = useForm<TOptionType>({
        defaultValues: {
            value: [0],
            prompt: "",
            buttonSubmit: "",
                ...
                {!isChecked ? (
                    <Box bg="white" borderRadius="xl" p="7">
                        <HStack as={"form"} onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Button colorScheme="blue" size="lg" type="submit" isDisabled={watch('value').length === 1}>
                                Cari properti
                            </Button>
                        </HStack>
                    ...
                    <Box bg="white" borderRadius="xl" p="7">
                        <HStack as={"form"} onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Button colorScheme="blue" size="lg" type="submit" isDisabled={watch("prompt") === ""}>
                                Cari properti
                            </Button>
                        </HStack>
                        <Text color="blue.500">*khusus daerah kota depok</Text>
